    ...
    <section className="section-padding bg-gradient-to-br from-gray-50 to-white">
      <div className="container-custom">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto mt-12 animate-slide-up delay-400">
          <div className="bg-white rounded-xl p-4 shadow-soft border-2 border-blue-100">
          ...
          <div className="bg-white rounded-xl p-4 shadow-soft border-2 border-green-100">
            <div className="flex items-center gap-3">
          ...
          <div className="bg-white rounded-xl p-4 shadow-soft border-2 border-purple-100">
            <div className="flex items-center gap-3">
