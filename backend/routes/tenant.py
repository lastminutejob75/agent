...
def tenant_me(auth: dict = Depends(require_tenant_auth)):
    ...
    return {
        ...
        "transfer_registered_only": params.get("transfer_registered_only") is None or _is_truthy(params.get("transfer_registered_only")),
        ...
        "notify_requests_sms": params.get("notify_requests_sms") is None or _is_truthy(params.get("notify_requests_sms")),
        "notification_phone": params.get("notification_phone", ""),
...
def tenant_patch_params(
    ...
    allowed = {
        ...
        "transfer_number", "transfer_practitioner_phone", "transfer_assistant_phone",
        ...
        "transfer_registered_only",
        "transfer_config_confirmed_signature", "transfer_config_confirmed_at",
        "notify_requests_sms", "notification_phone", "notification_email",
        "inbound_mode",
