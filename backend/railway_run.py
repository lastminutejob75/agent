...
def main() -> int:
    ...
    cmd = (
        ...
        "python -m backend.run_migration 028 || true; "
        "python -m backend.run_migration 029 || true; "
        "python -m backend.run_migration 030 || true; "
        "python -m backend.run_migration 031 || true; "
        "python -m backend.run_migration 038 || true; "
        "python -m backend.run_migration 049 || true; "
        "python -m backend.run_migration 052 || true; "
        "python -m backend.run_migration 053 || true; "
